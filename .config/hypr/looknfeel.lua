--[[
  Look & feel: layout, decoration, misc, cursor, and animations.

  Equivalent to the old looknfeel.conf, with current theme colours
  merged in so theme-switching continues to work.
--]]
...
hl.config({
  ...
  group = {
    ...
    groupbar = {
      ...
      text_color_inactive = theme.foreground_inactive,
      col = {
        active = theme.color0,
